...
- Reduced published package size by disabling sourcemaps in the shipped build, enabling minification/tree-shaking, and keeping test tooling out of runtime dependencies.
